...
<html>
<head>
    <title>Average CTC per Year</title>
...
<body>
    ...
    <?php
        ...
        $sql = "SELECT YEAR(begin_date) AS year, AVG(ctc) AS avg_ctc FROM first_company GROUP BY YEAR(begin_date) ORDER BY YEAR(begin_date)";
    ...
    <script>
        ...
        var avgCtc = <?php echo json_encode($avgCtc); ?>;
